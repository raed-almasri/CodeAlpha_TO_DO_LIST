...
const todoCountCompleted = document.getElementById("todoCountCompleted");
const todoCountNotCompleted = document.getElementById("todoCountNotCompleted");
...
function displayTasks() {
    ...
    todoCountNotCompleted.textContent = todo.filter(
        (item) => item.disabled == false
    ).length;
    todoCountCompleted.textContent = todo.filter(
